$(document).ready(function(){
	...
	setInterval(function() {
		...
		display = year + '岁' + month + '个月' + day + '天' + hour + '小时' + minute + '分钟' + second + '秒,' + days + '天.';
