...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        if ($options) {
            ...
            Yii::info('@@@upload options:' . $optionsJson,'auvtime');
        }
        if ($error_messages) {
            $this->error_messages = $error_messages + $this->error_messages;
            $error_messages_json = Json::encode($this->error_messages);
            Yii::info('@@@upload $error_messages:' . $error_messages_json,'auvtime');
        }
        if ($initialize) {
            $this->initialize();
        }
    ...
    protected function initialize() {
    	Yii::info('@@@upload REQUEST_METHOD:' . $this->get_server_var('REQUEST_METHOD'),'auvtime');
    ...
    public function post($print_response = true) {
        ...
        Yii::info('@@@upload $file_name:'.$file_name,'auvtime');
        Yii::info('@@@upload $content_range:'.$content_range,'auvtime');
        Yii::info('@@@upload $size:'.$size,'auvtime');
        $files = array();
        if ($upload && is_array($upload['tmp_name'])) {
            // param_name is an array identifier like "files[]",
            // $_FILES is a multi-dimensional array:
        	Yii::info('@@@upload multi-dimensional array','auvtime');
            ...
            Yii::info('@@@upload one-dimensional array','auvtime');
            $files[] = $this->handle_file_upload(
